                ...
                <div class="grid grid-cols-4 grid-rows-1 mt-3 gap-8 mb-10">
                    ...
                    <div class="col-span-3 grid-cols-1">
                        <inertia-link :href="'/user/' + review.user_id" class="row-span-1 flex mb-8">
                            <div class="bg-blue-primary rounded-full bg-cover bg-center h-16 w-16 inline-block mr-3" :style="{'background-image':'url(/storage/'+ review.profile_photo_path + ')'}"></div>
                            <div>
                                <h3>
                                    {{ review.name }}
                                </h3>
