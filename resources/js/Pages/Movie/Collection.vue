<template>
    <app-layout>
        ...
        <div v-else>
            ...
            <div class="h-screen flex flex-wrap bg-center bg-cover bg-fixed" :style="{'background-image':'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9)), url(https://image.tmdb.org/t/p/original' + collection[0].backdrop_path + ')'}">
                <inertia-link class="m-10 mb-0 mr-0 text-center flex flex-col items-center inline-block" v-for="(movie, index) in collection" :key="index" :href="'/movie/' + movie.id">
                    ...
                    <div class="w-48 text-white text-center flex flex-col flex-wrap items-center">
