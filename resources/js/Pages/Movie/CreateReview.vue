<template>
    <app-layout>
        ...
        >
            <div
                class="h-24 w-16 bg-center bg-cover"
                :style="{
                    'background-image':
        ...
        >
            <div>
                ...
                <div
                    v-if="this.success.length"
                    class="
                        m-5
                        bg-successGreen
                        text-successGreenBorder
                        border border-successGreenBorder
                        text-green-700
                        px-4
                        py-3
                        rounded
                ...
                >
                    ...
                    <p class="mt-1">
                        <inertia-link class="underline" href="/diary"
                            >Return to diary</inertia-link
                        >
                        or
                        <inertia-link class="underline" href="/movie/search"
                            >Create another review</inertia-link
                        >
                    </p>
                </div>
            ...
            <div class="h-full">
                <label for="review" class="block text-white text-2xl">
                    <div class="p-6 bg-blue-primary">Review</div>
                    <textarea
                        class="w-full h-40 text-black p-5 pt-2 -mb-2 h-full"
                ...
                <label for="notes" class="block text-white text-2xl">
                    <div class="p-5 bg-blue-primary">Notes</div>
                    <textarea
                        class="w-full h-40 text-black p-5 pt-2"
                        placeholder="Use this field to write down some notes such as where you saw the film, who with, film stock, etc.&#10;&#10;Only you will be able to see this"
                        name="notes"
                        id="notes"
                        cols="30"
                        rows="10"
...
<script type="text/javascript">
    ...
    export default {
        ...
        methods: {
            ...
            onSubmit() {
                axios
                    .post("/diary/" + this.movie.id + "/create", {
