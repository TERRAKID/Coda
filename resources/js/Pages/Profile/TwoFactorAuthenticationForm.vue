<template>
    <jet-action-section>
        ...
        <template #content>
            <h3 class="text-lg font-semibold mt-4" v-if="twoFactorEnabled">
                You have enabled two factor authentication.
            </h3>

            <h3 class="text-lg font-semibold mt-4" v-else>
            ...
            <div v-if="twoFactorEnabled">
                ...
                <div v-if="recoveryCodes.length > 0">
                    ...
                    <div
                        class="inline-block space-y-1 font-serif mt-4 px-4 py-4 text-sm bg-white rounded-xl"
                    >
            ...
            <div class="mt-4">
                ...
                <div v-else class="flex justify-between gap-4 w-full">
                    ...
                    <jet-confirms-password
                        ...
                        v-if="recoveryCodes.length === 0"
                    >
                        <jet-button class="w-full"> Show Codes </jet-button>
                    </jet-confirms-password>
